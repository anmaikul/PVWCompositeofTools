...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["Girder"] = __webpack_require__(2);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _monologue = __webpack_require__(21);
	...
	function mustContain() {
	    ...
	    return { missingKeys: missingKeys, promise: promise };
	}
	...
	function createClient() {
	    ...
	    var _extractLocalToken$up = {
	        ...
	        updateGirderInstance: function updateGirderInstance() {
	            ...
	            client._ = _axios2.default.create({ baseURL: baseURL, timeout: timeout, headers: headers });
	        },
	    ...
	    var publicObject = {
	        login: function login(username, password) {
	            ...
	            return busy(client._.get('/user/authentication', { auth: auth }).then(function (resp) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	( function( root, factory ) {
		...
		if ( true ) {
			...
			!(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(22), __webpack_require__(24) ], __WEBPACK_AMD_DEFINE_RESULT__ = function( _, riveter ) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (root, factory) {
	    if (true) {
	        // AMD. Register as an anonymous module.
	        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(25)], __WEBPACK_AMD_DEFINE_RESULT__ = function (_) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {if(!global["Girder"]) global["Girder"] = {};
	module.exports = global["Girder"]["services"] = __webpack_require__(27);
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }())))
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.core = exports.hpccloud = exports.all = undefined;

	var _core = __webpack_require__(28);

	var _core2 = _interopRequireDefault(_core);

	var _hpccloud = __webpack_require__(38);

	var _hpccloud2 = _interopRequireDefault(_hpccloud);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var all = exports.all = [].concat(_core2.default, _hpccloud2.default);

	exports.hpccloud = _hpccloud2.default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _assetstore = __webpack_require__(29);
	...
	var _folder = __webpack_require__(32);
	...
	var _system = __webpack_require__(36);
	...
	exports.default = function (_ref) {
	    ...
	    return {
	        ...
	        createAssetStore: function createAssetStore(assetstore) {
	            ...
	            var params = filterQuery(assetstore, [].concat(required, possible));
	        ...
	        updateAssetStore: function updateAssetStore(assetstore) {
	            var expected = ['name', 'root', 'db', 'current', 'id'],
	                params = filterQuery(assetstore, expected.slice(0, expected.length - 1)); // Remove 'id'

	            return client._.put('/assetstore/' + assetstore.id, { params: params });
	        },
	...
	exports.default = function (_ref) {
	    ...
	    return {
	        ...
	        editCollection: function editCollection() {
	            ...
	            var _mustContain2 = mustContain(collection, 'id');

	            var missingKeys = _mustContain2.missingKeys;
	            var promise = _mustContain2.promise;

	            return missingKeys ? busy(client._.put('/collection/' + collection.id + encodeQueryAsString(params))) : promise;
	        },
	        ...
	        editCollectionAccess: function editCollectionAccess(collection) {
	            ...
	            var _mustContain3 = mustContain(collection, 'id');

	            var missingKeys = _mustContain3.missingKeys;
	            var promise = _mustContain3.promise;

	            return missingKeys ? busy(client._.put('/collection/' + collection.id + '/access' + encodeQueryAsString(params))) : promise;
	        }
	    };
	};
...
/***/ function(module, exports) {
	...
	exports.default = function (_ref) {
	    ...
	    return {
	        uploadChunk: function uploadChunk(_ref2) {
	            var uploadId = _ref2.uploadId;
	            var offset = _ref2.offset;
	            var chunk = _ref2.chunk;

	            var transformRequest = noTransform,
	                data = new FormData();
	            ...
	            return busy(client._.post('/file/chunk', data, { transformRequest: transformRequest }));
	        },
	        uploadComplete: function uploadComplete(id) {
	            var transformRequest = noTransform,
	                data = new FormData();
	        ...
	        editFile: function editFile(file) {
	            ...
	            var _mustContain = mustContain(file, 'id');

	            var missingKeys = _mustContain.missingKeys;
	            var promise = _mustContain.promise;

	            return missingKeys ? busy(client._.put('/file/' + file.id + encodeQueryAsString(params))) : promise;
	        },
	...
	exports.default = function (_ref) {
	    ...
	    return {
	        ...
	        editFolder: function editFolder(folder) {
	            ...
	            var _mustContain2 = mustContain(folder, 'id');

	            var missingKeys = _mustContain2.missingKeys;
	            var promise = _mustContain2.promise;

	            return missingKeys ? busy(client._.put('/folder/' + folder.id + encodeQueryAsString(params))) : promise;
	        },
	        ...
	        editFolderAccess: function editFolderAccess(folder) {
	            ...
	            var _mustContain3 = mustContain(folder, 'id');

	            var missingKeys = _mustContain3.missingKeys;
	            var promise = _mustContain3.promise;

	            return missingKeys ? busy(client._.put('/folder/' + folder.id + '/access' + encodeQueryAsString(params))) : promise;
	        }
	    };
	};
	...
	exports.default = function (_ref) {
	    ...
	    return {
	        ...
	        editGroup: function editGroup() {
	            ...
	            var _mustContain2 = mustContain(group, 'id');

	            var missingKeys = _mustContain2.missingKeys;
	            var promise = _mustContain2.promise;

	            return missingKeys ? busy(client._.put('/group/' + group.id + encodeQueryAsString(params))) : promise;
	        },
...
/***/ function(module, exports) {
	...
	exports.default = function (_ref) {
	    ...
	    return {
	        downloadItem: function downloadItem(id) {
	        ...
	        listItems: function listItems() {
	            ...
	            return busy(client._.get('/item', { params: params }));
	        },
	        ...
	        listFiles: function listFiles(id, query) {
	            ...
	            return busy(client._.get('/item/' + id + '/files', { params: params }));
	        },
	        ...
	        editItem: function editItem(item) {
	            ...
	            var _mustContain = mustContain(params, 'id');

	            var missingKeys = _mustContain.missingKeys;
	            var promise = _mustContain.promise;

	            return missingKeys ? busy(client._.put('/item/' + item.id + encodeQueryAsString(params))) : promise;
	        },
	...
	exports.default = function (_ref) {
	    ...
	    return {
	        ...
	        searchResources: function searchResources(query, types) {
	            var params = { q: JSON.toString(query), types: JSON.toString(types) };
	...
	exports.default = function (_ref) {
	    ...
	    return {
	        ...
	        createUser: function createUser(user) {
	            ...
	            var params = filterQuery(user, expected);
	        ...
	        changePassword: function changePassword(old, newPassword) {
	            ...
	            return busy(client._.put('/user/password', { params: params }));
	        },
	        ...
	        updateUser: function updateUser(user) {
	            var expected = ['email', 'firstName', 'lastName', 'id'];
	            var params = filterQuery(user, expected.slice(0, 3));
	            ...
	            return missingKeys ? promise : busy(client._.put('/user', { params: params }));
	        }
	    };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _simulations = __webpack_require__(40);

	var _simulations2 = _interopRequireDefault(_simulations);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	exports.default = [_projects2.default, _simulations2.default];
	...
	exports.default = function (_ref) {
	    ...
	    return {
	        ...
	        updateProject: function updateProject(project) {
	            var expected = ['name', 'type', 'steps', 'metadata', 'id'];
	            var pfiltered = filterQuery(project, expected.slice(0, 4));
	            ...
	            return missingKeys ? promise : busy(client._.put('/projects/' + project.id, pfiltered));
	        },
