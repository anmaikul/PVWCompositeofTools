...
export default React.createClass({
  ...
  componentWillMount() {
    ...
    this.queryDataModelDataSubscription = queryDataModel.onDataChange((data, envelope) => {
      this.setState({ chartData: imageBuilder.getProbeLine(this.state.chartAxis) });
    });
    ...
    this.chartListenerSubscription = imageBuilder.onProbeLineReady((data, envelope) => {
      var test1 = this;
      //var test2 = this.liveChartAxis;
      var chartData = data[chartAxisNames[this.state.chartAxis]];
  ...
  validateChartAxis() {
    var renderCoords = this.props.imageBuilder.getRenderMethod(),
      chartAxis = 'XYZ'[this.state.chartAxis];
