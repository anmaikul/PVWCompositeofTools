...
function fieldSelector(publicAPI, model) {
  ...
  publicAPI.setContainer = (el) => {
    ...
    if (el) {
      ...
      d3.select(model.container).style('overflow-y', 'auto');
  ...
  publicAPI.render = () => {
    ...
    //const legendSize = 15;
    let avgSize = (parseFloat(model.container.style.width)+parseFloat(model.container.style.height))/75;
    const legendSize = avgSize > 15 ? avgSize : 15;
    ...
    function renderField(fieldName, index) {
      ...
      // Apply field name
      fieldCell.style("font-size", legendSize + "px");
