...
export default class PlotlyChartBuilder {
  ...
  buildChart() {
    if (this.chartState.chartType) {
      ...
      // ONLY returns the traces, no other plot metadata
      ...
      // allow for returning all plot data from builders (currently only
      // for implemented for Histogram2D)
      const plotData = builder(this.chartState, this.csvReader, dataArrays);
      if (plotData) {
